...
const checks = [
  ...
  ["VITE_BOND_CONTEXT_RESOLVER_ADDRESS", isAddress(env.VITE_BOND_CONTEXT_RESOLVER_ADDRESS ?? "")],
  ...
  ["VITE_ALTERFORD_FORWARDER_ADDRESS", isAddress(env.VITE_ALTERFORD_FORWARDER_ADDRESS ?? "")],
